...
public class CharactersT
{
    ...
    [
        ...
        new()
        {
            Name = "The Destroyer (Sharon Carter)",
            Rank = 3,
            Abilities = new Abilities
            (
            ...
            [
                new CharacterPowerSet
                {
                    ...
                    [
                        powerSelector.GetPower(PowerNames.Accuracy1),
                        powerSelector.GetPower(PowerNames.IconicWeapon, specialization: "Energy Baton (melee weapon; ignores one level of damage reduction)"),
            ...
            Biography = new Biography
            {
                ...
                Origins = [OriginName.HighTech, OriginName.SpecialTraining],
                Teams = [TeamNames.DaughtersOfLiberty, TeamNames.SHIELD, TeamNames.Thunderbolts],
                Base = "Mobile",
                History =
                [
