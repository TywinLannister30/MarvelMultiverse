        ...
        new()
        {
            ...
            [
                new IconicItem
                {
                    ...
                    Powers =
                    [
                        iconicItemPowerSelector.GetPowersAsIconicItemPower(PowerNames.AdditionalLimbs, powerSelector.GetPower(PowerNames.AdditionalLimbs)),
                        iconicItemPowerSelector.GetPowersAsIconicItemPower(PowerNames.BangingHeads, powerSelector.GetPower(PowerNames.BangingHeads)),
                        ...
                        iconicItemPowerSelector.GetPowersAsIconicItemPower(PowerNames.ExtendedReach1, powerSelector.GetPower(PowerNames.ExtendedReach1, reminder: "Reach 4")),
                        ...
                        iconicItemPowerSelector.GetPowersAsIconicItemPower(PowerNames.QuickToss, powerSelector.GetPower(PowerNames.QuickToss)),
