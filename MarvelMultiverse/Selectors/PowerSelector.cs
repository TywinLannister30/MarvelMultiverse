    ...
    [
        ...
        new()
        {
            ...
            [
                ...
                "- Blood Curse: If the user gets a Fantastic success on an attack and causes bleeding, their powers are boosted. However, they also gain the Bloodthirsty tag. If they kill someone while Bloodthirsty, they lose their Heroic tag.",
                "- Bloodied: If the user gets a Fantastic success on an attack and causes bleeding, their powers are boosted. If they are knocked unconscious by a foe in battle, they die.",
                ...
                "- Great Need: If the character has a great need for an increase in their power, they can voluntarily boost their powers. After the current combat or encounter, they are exhausted as if they had not slept for 72 hours, and they must sleep for 72 hours to recover.",
